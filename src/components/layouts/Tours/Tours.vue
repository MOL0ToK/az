...
export default {
  data: () => ({
    concerts: [
      ...
      { date: '27.01', city: 'АТМОСФЕРА', link: 'https://vk.com/atmosferasurgut', place: 'СУРГУТ' },
      { date: '08.02', city: 'ИЖЕВСК', link: 'https://vk.com/animal_izh', place: 'Пинта Бар' },
      { date: '15.02', city: 'ЧАРТОВА ДЮЖИНА', link: 'https://vk.com/wall-28866484_2111187', place: '' },
      { date: '22.02', city: 'ВОРОНЕЖ', link: 'https://vk.com/animalzvrn18', place: 'STATION MIR' },
      { date: '27-29.07', city: 'ДОБРОФЕСТ', link: 'https://vk.com/dobrofest', place: '' },
    ],
    months,
  }),
  methods: {
